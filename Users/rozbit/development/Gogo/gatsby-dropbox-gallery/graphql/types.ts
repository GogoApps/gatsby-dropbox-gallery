...
export type DropboxNodeLastModifiedArgs = {
  formatString?: Maybe<Scalars['String']>,
  fromNow?: Maybe<Scalars['Boolean']>,
  difference?: Maybe<Scalars['String']>,
  locale?: Maybe<Scalars['String']>
...
export type DropboxNodeConnection = {
  totalCount: Scalars['Int'],
  edges: Array<DropboxNodeEdge>,
  nodes: Array<DropboxNode>,
  pageInfo: PageInfo,
  distinct: Array<Scalars['String']>,
  group: Array<DropboxNodeGroupConnection>,
};


export type DropboxNodeConnectionDistinctArgs = {
  field: DropboxNodeFieldsEnum
};


export type DropboxNodeConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>,
  limit?: Maybe<Scalars['Int']>,
  field: DropboxNodeFieldsEnum
};

export type DropboxNodeEdge = {
  next?: Maybe<DropboxNode>,
  node: DropboxNode,
  previous?: Maybe<DropboxNode>,
};

export type DropboxNodeFieldsEnum = 
  'id' |
  'parent___id' |
  'parent___parent___id' |
  'parent___parent___parent___id' |
...
export type DropboxNodeFilterInput = {
  id?: Maybe<StringQueryOperatorInput>,
  parent?: Maybe<NodeFilterInput>,
  children?: Maybe<NodeFilterListInput>,
  internal?: Maybe<InternalFilterInput>,
...
export type DropboxNodeGroupConnection = {
  totalCount: Scalars['Int'],
  edges: Array<DropboxNodeEdge>,
  nodes: Array<DropboxNode>,
  pageInfo: PageInfo,
...
export type DropboxNodeSortInput = {
  fields?: Maybe<Array<Maybe<DropboxNodeFieldsEnum>>>,
  order?: Maybe<Array<Maybe<SortOrderEnum>>>,
};
...
export type Query = {
  ...
  dropboxNode?: Maybe<DropboxNode>,
  allDropboxNode: DropboxNodeConnection,
  site?: Maybe<Site>,
...
export type QueryDropboxNodeArgs = {
  id?: Maybe<StringQueryOperatorInput>,
  parent?: Maybe<NodeFilterInput>,
  children?: Maybe<NodeFilterListInput>,
  internal?: Maybe<InternalFilterInput>,
...
export type QueryAllDropboxNodeArgs = {
  filter?: Maybe<DropboxNodeFilterInput>,
  sort?: Maybe<DropboxNodeSortInput>,
  skip?: Maybe<Scalars['Int']>,
  limit?: Maybe<Scalars['Int']>
};
...
export type SitePageFieldsEnum = 
  ...
  'pluginCreator___pluginOptions___recursive' |
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  path?: Maybe<StringQueryOperatorInput>,
  recursive?: Maybe<BooleanQueryOperatorInput>,
...
export type PhotosPageQuery = { allDropboxNode: { edges: Array<{ node: Pick<DropboxNode, 'id' | 'name' | 'lastModified' | 'path'> }> } };
